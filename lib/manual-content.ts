...
export const HOTKEYS_MANUAL = [
  { atalho: "1", descricao: "Navega para o Cockpit Matinal" },
  { atalho: "2", descricao: "Navega para o Chain de Opções" },
  { atalho: "3", descricao: "Navega para o Workbench de Estratégias" },
  { atalho: "4", descricao: "Navega para o Scanner de Pozinhos" },
  { atalho: "5", descricao: "Navega para a Carteira & Journal" },
  { atalho: "6", descricao: "Navega para Notícias & Calendário Macro" },
  { atalho: "7", descricao: "Navega para Histórico & Volatilidade" },
  { atalho: "8", descricao: "Navega para a Watchlist & Skew" },
