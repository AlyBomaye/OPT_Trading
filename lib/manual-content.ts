...
export const PLATAFORMA_COMO_SERVICO = [
  ...
  { titulo: "Senha em produção", texto: "A produção exige APP_PASSWORD no .env.local (sem ela, 503 em tudo — é a porta de entrada do WO-37). Você entra pela tela /entrar; o vigia e o sync leem a mesma senha do .env.local e entram sozinhos por /api/entrar. Só /api/saude fica fora da senha, e só diz 'estou vivo'." },
