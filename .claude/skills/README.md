...
| `risco-do-book` | Carteira, VaR, stress, hedge, vencimento, atribuição | leitura das gregas do book; VaR por grade vs simulação histórica; economia do hedge com custos XP; limites em R$ |
| `boletagem-e-custos` | Boletar, boleta, estorno, caixa, custos, IR, Excel | livro append-only no Postgres; tabela oficial XP/B3; zeragem a custo zero; regras fiscais |
