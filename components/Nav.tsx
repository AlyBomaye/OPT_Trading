...
import { Gauge, Table2, GitBranch, Search, Briefcase } from "lucide-react";
...
export function Nav() {
  ...
  // Atalhos: teclas 1–5 navegam entre módulos (fora de inputs)
  useEffect(() => {
  ...
  return (
    <nav className="w-40 shrink-0 border-r border-term-line bg-term-panel flex flex-col">
      ...
      <div className="px-3 py-2 text-xxs text-term-dim border-t border-term-line">
        Atalhos: <kbd>1</kbd>–<kbd>5</kbd> módulos · <kbd>R</kbd> atualizar
      </div>
    </nav>
  );
}
